		...
		<aside id="fh5co-aside" role="complementary" class="js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li class="fh5co-active"><a href="contactView">Contacto</a></li>
				</ul>
			</nav>
						...
						<div class="col-md-4">
							<div class="fh5co-feature fh5co-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="fh5co-text">
									<p>labanimacioncesge@gmail.com</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="fh5co-feature fh5co-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="fh5co-text">
									<p>SENA - Centro de Servicios y Gestión Empresarial<br>Cl. 51 #57-70, Medellín, Antioquia, Colombia</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="fh5co-feature fh5co-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="fh5co-text">
									<p>+57 312-214-75-66 - Gabriel Silva</p>
								</div>
							</div>
						</div>
					</div>
